...
## Visual rules
- Real pets (dogs/cats) in clean, well-lit, natural settings; avoid heavy artificial
  filters.
- Product pack must be clearly legible; hero the pack on packshots.
- Palette: clean whites, Hill's brand orange/red accents, soft neutral backgrounds.
...
## Approved angles
Nutrition science, life-stage-appropriate formulation, visible vitality/energy,
digestive and coat health described in wellness (not medical-cure) terms.
